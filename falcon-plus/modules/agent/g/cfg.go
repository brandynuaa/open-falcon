...
type GlobalConfig struct {
	...
	System        string            `json:"system"` //add by wjl 2019-03-20:aiops
	Hostname      string            `json:"hostname"`
	IP            string            `json:"ip"`
	Nrtransfer    bool              `json:"nrtransfer"` // add by wjl 2019-03-21: aiops 1)true: json format directly, 2)false: falcon format
